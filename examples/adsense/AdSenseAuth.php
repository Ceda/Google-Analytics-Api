...
class AdSenseAuth {
  ...
  public function __construct() {
    ...
    $this->apiClient->setClientId('304483255824');
    $this->apiClient->setClientSecret('uXRSh76Jrfa2hS78PaIbYYGo');
    $this->apiClient->setDeveloperKey('YOUR_DEVELOPER_KEY_HERE');
    // Point the oauth2_redirect_uri to index.php.
    $this->apiClient->setRedirectUri('http://localhost/google-api-php-client-read-only/index.php');
